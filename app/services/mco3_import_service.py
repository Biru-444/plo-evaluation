...
- flags: รายการปัญหา/ข้อสังเกตที่แอดมินต้องตรวจสอบเอง ก่อนบันทึกข้อมูลจริง (Phase นี้ยังไม่บันทึก
  ...
  checkbox_ambiguous ด้านบน ยังมีอีก 4 กรณีที่ต้อง flag:
    - "duplicate_course_code": ถ้ารหัสวิชาที่ปรากฏในเอกสารขัดแย้งกันเอง เช่นรหัสวิชาในหมวดที่ 1
      (ข้อมูลทั่วไป) ไม่ตรงกับรหัสที่ระบุในหมวดที่ 2 ข้อ 1 (คำอธิบายรายวิชา/ความสัมพันธ์กับ PLO) - เป็น
      คนละเลขกันไปเลย ไม่ใช่แค่พิมพ์ผิดหลักเดียว (เช่นหมวดที่ 1 เขียน 4122301 แต่หมวดที่ 2 เขียน
      4123310) ให้ระบุในข้อความว่าเจอค่าไหนบ้างที่ตำแหน่งไหน
    ...
    - "title_content_mismatch": หัวเรื่องบนสุดของเอกสาร (บรรทัดแบบ "รายละเอียดของรายวิชา...") ไม่ตรง
      กับรหัส/ชื่อวิชาที่ปรากฏจริงในเนื้อหาหมวดที่ 1/2 เช่น หัวเรื่องเขียนว่า "รายละเอียดของรายวิชา
      ระบบฐานข้อมูล" แต่เนื้อหาทั้งหมด (รหัสวิชา, คำอธิบายรายวิชา, CLO ฯลฯ) เป็นของวิชา "โครงสร้าง
      ข้อมูล" รหัส 4122305 - นี่คือคนละกรณีกับ duplicate_course_code (ซึ่งขัดแย้งกันเองภายในเนื้อหา
      หมวดต่างๆ) เพราะ title_content_mismatch คือหัวเรื่อง/ปก vs เนื้อหาข้างใน
